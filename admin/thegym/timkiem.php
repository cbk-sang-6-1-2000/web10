...
<html lang="en">
   ...
   <body class="main-layout">
	...
	<!-- new collection section start -->
  	<div class="collection_text" style =";font-size: 30px;font-family: 'Times New Roman', Times, serif; padding : 15px 0px; margin-top: 106px">Quản Lý Thẻ Gym</div>
...
if (isset($_REQUEST['ok'])) 
{
    ...
    {
        $sql = "select *from gymcard where cardName LIKE '%$search%'";
        $card_list = executeResult($sql);
        if ($card_list > 0 && $search != "") 
        {
	        ...
	        echo '<tr>
                        ...
                        <td>
                            <a href="them.php?idCard='.$item['idCard'].'"><button class="btn btn-warning">Sửa</button></a>
                        </td>
                        <td>
                            <button class="btn btn-danger" onclick="card_list('.$item['idCard'].')">Xoá</button>
                        </td>
                </tr>';
