...
<html lang="en">
   ...
   <body class="main-layout">
    ...
    margin-right: 77px;">Thêm Đăng Ký</button>
				</a>
				<div>
					...
					<table class="table table-bordered table-hover" style ="text-align: center; width: 90%; margin: auto; font-weight: 900; margin-bottom: 25px; border: 5px solid">
						...
						<tbody>
                        <?php
                            $sql = 'select p.NamePT,ur.id, m.Name, m.NumberPhone, m.picture, r.RentName, r.pricedv from members m join userent ur on ur.idMembers = m.idMembers join rent r on r.idRent = ur.idRent LEFT JOIN personaltrainer p on r.idPT = p.idPT';
