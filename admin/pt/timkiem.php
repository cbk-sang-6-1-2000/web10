...
<html lang="en">
   ...
   <body class="main-layout">
	...
	<!-- new collection section start -->
  	<div class="collection_text" style =";font-size: 30px;font-family: 'Times New Roman', Times, serif; padding : 15px 0px; margin-top: 106px">Quản Lý Huấn Luyện Viên</div>
...
if (isset($_REQUEST['ok'])) 
{
    ...
    {
        $sql = "select *from personaltrainer where NamePT LIKE '%$search%'";
        ...
        if ($PT_list > 0 && $search != "") 
        {
	        ...
	        echo '<tr>
                    ...
                    <td>'.$item['Email'].'</td>
                    <td>
                        <a href="them.php?idPT='.$item['idPT'].'"><button class="btn btn-warning">Sửa</button></a>
                    </td>
                    <td>
                        <button class="btn btn-danger" onclick="PT_list('.$item['idPT'].')">Xoá</button>
                    </td>
                </tr>';
