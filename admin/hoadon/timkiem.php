				...
				<div>
					...
					<table class="table table-bordered table-hover" style ="text-align: center; width: 90%; margin: auto; font-weight: 900; margin-bottom: 25px; border: 5px solid;">
                        ...
                        if (isset($_REQUEST['ok'])) 
                        {
							...
							from members m LEFT JOIN revenue h ON m.idMembers = h.idMembers LEFT JOIN userent ON userent.idMembers = m.idMembers LEFT JOIN rent ON userent.idRent = rent.idRent LEFT JOIN gymcard on m.idCard = gymcard.idCard where m.Name LIKE '%$search%'
