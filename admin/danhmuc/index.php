   ...
   <body class="main-layout">
    ...
    padding: 20px;">
					...
					<table class="table table-bordered table-hover" style ="text-align: center; width: 90%; margin: auto; font-weight: 900; margin-bottom: 25px; border: 5px solid">
						...
						<tbody>
                        <?php
                            $sql = 'select category.idCategory, category.CategoryName, COUNT(equipment.idCategory) from category left join equipment on category.idCategory = equipment.idCategory GROUP BY idCategory';
